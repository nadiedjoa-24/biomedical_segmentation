...
from dualrazor import hairRemoval
...
IMG_PATH = os.path.normpath(
    os.path.join(BASEDIR, '..', 'dataset', 'nevus', 'ISIC_0000042.jpg')
)
...
if __name__ == "__main__":
    ...
    img_cropped, mask_uint8 = isolate_dermato_circle_adaptive(img_rgb, crop=True)

    # 3) Hair removal sur l'image croppée
    mask_bool = mask_uint8 > 0
    img_no_hair = hairRemoval(img_cropped, mask_bool)




    # 4) Sauvegarde des résultats
    out_cropped_path = os.path.join(SAVE_PATH, "ISIC_0000042_cropped.png")
    out_clean_path   = os.path.join(SAVE_PATH, "ISIC_0000042_nohair.png")
